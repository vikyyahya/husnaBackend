    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 offset-md-4">
            ...
            <div class="account-wall">
                <img class="profile-img" src="<?php echo base_url('image/photo.png'); ?>"
                    alt="">    
                <form class="form-signin" method="POST" action="<?php echo base_url() ?>/login">
                <div class="form-group">
                    <input type="text" class="form-control" name="user_name" placeholder="Masukkan Username Anda" autofocus>
