...
define('_SESSION_PATH_',  _ADMIN_PATH_ . "ses_486d8e0180ae68c57993fe4f{$path_separator}");
...
// Time zone settings
//------------------------------------------------------------------------
$time_zone_locale = 'Asia/Jakarta'; // a full list can be found at http://uk.php.net/manual/en/timezones.php
