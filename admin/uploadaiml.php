...
<body id="page-top">
    ...
    <?php require_once ('../application/views/admin/_partials/navbar2.php'); ?>
   <div id="wrapper">
    <?php require_once ('../application/views/admin/_partials/sidebar2.php'); ?>
...
<?php echo $all_bots;?>
    <?php require_once ('../application/views/admin/_partials/js.php'); ?>
